...
st.set_page_config(page_title="Cease and Desist", page_icon=":octagonal_sign:")
...
st.title("""
:Disclaimer: Any use of the following form letter should not be taken as legal advice. 
...
with st.container():
    ...
    if st.button("Generate Letter", key="generate"):
        st.session_state.letter = f"""Dear {st.session_state.platform_legal},
            ...
            \n This letter shall serve as notice that absent the swift removal from {st.session_state.platform_nn}'s site of the aforementioned doxing material I am prepared to retain an attorney and take steps towards the resolution of this matter. The harassment published on your platform may violate federal law against stalking, and/or state law, including but not limited to, in the states of Arizona, Colorado, Florida, Kentucky, Minnesota, Oklahoma, and Oregon, each of whom have laws explicitly targeting the practice of doxing. 
            ...
            \nThe harassment materials published at {url} evidently fall within the language regarding prohibited postings found at {st.session_state.platform_nn}'s Terms of Service found at {st.session_state.platform_tos}. {st.session_state.platform_tos_args}
